...
define( 'MRP_OPTION_ENABLE_REVSLIDER_COMPAT', 'mrp_enable_revslider_compat' );
...
if ( mrp_should_enable_revslider_compat() ) {
	require_once MRP_PLUGIN_DIR . 'includes/plugins/revslider.php';
}
